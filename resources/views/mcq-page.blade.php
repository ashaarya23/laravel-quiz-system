    ...
    <div class="bg-gray-100 flex flex-col items-center min-h-screen pt-5">
        ...
        <div class="mt-2 p-4 bg-white shadow-2xl rounded-xl w-140">
            ...
            <form action="/submit-next/{{$mcqData->id}}" class="space-y-4" method="post">
                ...
                <label for="option_1" class="flex border p-3 mt-2 rounded-xl shadow-2xl cursor-pointer hover:bg-blue-50">
                ...
                <label for="option_2" class="flex border p-3 mt-2 rounded-xl shadow-2xl cursor-pointer hover:bg-blue-50">
                ...
                <label for="option_3" class="flex border p-3 mt-2 rounded-xl shadow-2xl cursor-pointer hover:bg-blue-50">
                ...
                <label for="option_4" class="flex border p-3 mt-2 rounded-xl shadow-2xl cursor-pointer hover:bg-blue-50">
                ...
                <button type="submit" class="w-full bg-blue-500 rounded-xl px-4 py-2">Submit Answer and Next</button>
            </form>
        </div>     
    </div>
