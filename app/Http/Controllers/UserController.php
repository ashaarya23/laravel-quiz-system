...
class UserController extends Controller
{
       ...
       $link = url('/verify-user/' . $link);
        ...
        if($user){
            ...
            if(Session::has('quiz-url')){
               ...
               return redirect($url)->with('message-success','User Signup Successfully, Please check email to verify account.');
            }
            return redirect('/')->with('message-success','User Signup Successfully, Please check email to verify account.');
        }
    }
    ...
    function submitAndNext(Request $request, $id){
      ...
      Session::put('currentQuiz',$currentQuiz);
      if($mcqData){
        return view('mcq-page',['quizName'=>$currentQuiz['quizNmae'],'mcqData'=>$mcqData]);
      }else{
    ...
    function certificate(){
        $data = [];
        $data['quiz'] = str_replace('-',' ',session::get('currentQuiz')['quizNmae']);
    ...
    function downloadCertificate(){
        ...
        return response(
            ...
            'Content-dispositions' => 'attachment;filename=certificate.pdf'
        ]);
    }
}
